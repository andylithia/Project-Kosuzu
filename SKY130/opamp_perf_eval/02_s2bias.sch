...
lab=bias1}
N 2040 -1470 2040 -1370 {
lab=VDD}
C {devices/code_shown.sym} 2090 -1470 0 0 {name=s1 only_toplevel=false value="
...
C {devices/vsource.sym} 1960 -1440 0 0 {name=V2 value="AC 0.5"}
C {devices/gnd.sym} 2040 -1290 0 0 {name=l1 lab=GND}
C {devices/vsource.sym} 1880 -1440 0 0 {name=V3 value="AC -0.5"}
C {devices/vdd.sym} 2040 -1470 0 0 {name=l2 lab=VDD}
C {devices/vsource.sym} 1800 -1340 0 0 {name=Vbias2 value="0.7"}
...
C {devices/lab_wire.sym} 1960 -1470 0 0 {name=p3 sig_type=std_logic lab=vip}
C {devices/lab_wire.sym} 1880 -1470 0 0 {name=p4 sig_type=std_logic lab=vin}
